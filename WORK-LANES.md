...
| **C32** | `detect_price_drops.py` | M-251·M-334 기해결(타 세션, B28/H-124 연관) | ✅ 2026-06-13 |
| **C33** | `ocr_specs.py` | M-299=B25(H-116 dv=0)·M-300(INSERT/UPDATE 원자성) 기해결(타 세션) | ✅ 2026-06-13 |
...
## 2026-06-14 H/M 버그 일괄 처리 (bug-report.md SSOT)

DP 파이프라인 스윕에 이어 잔여 고/중위험 전량 처리 — **미처리 H·M 0건**.
상세·마킹은 [bug-report.md](bug-report.md) 현황 요약 참조. 보안(H-141/142/144)·HB/HF(H 백/프론트)·
